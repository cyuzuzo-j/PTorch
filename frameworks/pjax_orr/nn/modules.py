...
class ProbabilitySimplex(Module):
    """Projection onto the probability simplex.

    Implements a projection layer that maps input vectors onto the probability
    simplex, ensuring that the output is a valid probability distribution.

    Args:
        features: dimensionality of the input and output vectors.
    """