"""Diagnostic 6: 2000-step runs with best optimizers."""
import sys, os
...
for opt_name, opt_kwargs in configs:
    print(f"\n=== ResNet8 + {opt_name} {opt_kwargs} (2000 steps) ===")
    ...
    for step in range(2000):
        ...
        if step % 200 == 0 or step == 1999:
            ...
            val = eval_acc()
            print(f"  step={step:4d}  loss={ce_loss:.4f}  train_acc={train_acc:.4f}  val_acc={val:.4f}")
