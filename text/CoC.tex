...
% --TO BE FILLED IN--
\noindent
\textbf{Student name:} Jeff Cyuzuzo Jambé \hfill \textbf{Student number:} r0902205
...
This form is related to my O \textbf{Bachelor’s} or X \textbf{Master’s thesis.}

\begin{tabularx}{\linewidth}{@{}lXlX@{}}
\textbf{Title Bachelor’s or Master’s thesis:} & \small $\mathcal{P}$Torch Narrowing the Gap Between Projection and Gradient--Based Learning   \\
\textbf{Supervisor:} Prof.\,dr.\,ir.\,Panos Patrinos \\
\end{tabularx}

\vspace{1em}

\textbf{Daily supervisor:} Ir.\,Jan Quan
...
X I \textbf{did use} GenAI Assistance. In this case \textbf{specify which ones} (e.g.\ ChatGPT, M365 Copilot, …): Gemini, Claude code, antigravity, chatgpt, vscode-copilot
...
\textbf{As a language assistant for reviewing or improving texts I wrote myself} & claude, chatgpt, gemini & This use is similar to using spelling and grammar check tools. In general, you do not have to refer to such kind of GenAI use in the text. 
...
\end{itemize} \\ \hline
\textbf{For literature search} & claude, chatgpt, gemini & This use is comparable to e.g.\ a Google Scholar search. You do not have to refer to such kind of GenAI use; \textbf{you only have to \href{https://bib.kuleuven.be/english/training-and-tutorials/citation}{refer} to the literature references you have checked and used} (without such references you would be committing \href{https://www.kuleuven.be/english/education/plagiarism/index}{plagiarism} and thus committing an irregularity).
...
\end{itemize} \\ \hline
\textbf{For generating visuals, video or audio} & claude, chatgpt, gemini & Use of GenAI for generating visuals, audio or video is allowed except when it is prohibited by the teacher or the program of study. 
...
\end{itemize} \\ \hline
\textbf{Other use (specify here; this may also include a combination of types of use mentioned above):} & Co-development of mathematical proofs: Most proofs were written, completed, fixed, or verified by me using generative AI. Additionally, LLMs were used to automatically identify bugs and find working configurations, while Claude Code was used extensively to write benchmarks and conversions from math to code  & To make sure other use of GenAI is allowed within the course or thesis, and if so, the conditions that may apply, contact the teaching staff of the course or the supervisor of the thesis \textbf{beforehand} and explain the intended GenAI use. Also inform the programme director. 
