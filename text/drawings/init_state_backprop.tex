...
\begin{tikzpicture}[
    ...
    \node[focusLoss] (loss) at (29.0,0) {$\mathrm{prox}_{\lambda \mathcal{L}}\!\bigl(h^{(3)},\, y\bigr)$};
    \node[focusIo] (y) at (32.4,0) {$y$};
    ...
    \draw[active, line width=1.2pt] (h3) -- (loss);
    \draw[active, line width=1.2pt] (y) -- (loss);
