...
\begin{tikzpicture}[scale=1.0, every node/.style={font=\small}]
  ...
  \draw[line width=5pt, KUL-BLUE, opacity=0.2] (\xmin, 0) -- (0, 0);
  ...
  \fill[KUL-RED!80!black] (-2, 0) circle (2.2pt);
  \node[above=2pt, font=\tiny, text=black!90] at (-2, 0) {$h_1^{(3)}=-2$};
  ...
  \node[anchor=north west, draw=black!30, fill=white, fill opacity=1.0, text opacity=1,
    ...
    at (\xmin, -0.6)
        {\tikz \draw[KUL-BLUE, fill=KUL-BLUE, fill opacity=0.08] (0,0) rectangle (0.3, 0.15);  \scriptsize $h_1^{(3)}\in A_{13} \cap B_{\mathrm{out}}$};
BLUE
\end{tikzpicture}