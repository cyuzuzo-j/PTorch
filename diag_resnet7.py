"""Diagnostic 7: ResidualAdd vs ProjectedAdd comparison, 1000 steps."""
import sys, os
...
print(f"=== ResNet8 with ResidualAdd (1000 steps) ===")
...
for step in range(1000):
    ...
    if step % 100 == 0 or step == 999:
        ...
        val = eval_acc()
        print(f"  step={step:4d}  loss={ce_loss:.4f}  train_acc={train_acc:.4f}  val_acc={val:.4f}  feat_std={feat_std:.4f}")
