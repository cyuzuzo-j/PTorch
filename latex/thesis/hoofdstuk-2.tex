...
Gewoonlijk bevat een tekst ook formules in de lopende tekst
(\(\sin^2\eta + \cos^2\eta = 1\)) of als een aparte vergelijking.
\begin{equation}
...
\begin{figure}
  \centering
  \includegraphics{logokuleng-nl}
  \caption{Het logo van de Faculteit Ingenieurswetenschappen.}
  \label{fig:logo}
\end{figure}
