"""Diagnostic 9: ProjectionSGD with varying lr to control step size."""
import sys, os
...
configs = [
    ("AP lr=1.0 (full step)", "AlternatingProjections", {"lr": 1.0}),
    ("SGD lr=0.5", "ProjectionSGD", {"lr": 0.5}),
    ("SGD lr=0.3", "ProjectionSGD", {"lr": 0.3}),
    ("SGD lr=0.1", "ProjectionSGD", {"lr": 0.1}),
    ("SGD lr=0.5 mom=0.9", "ProjectionSGD", {"lr": 0.5, "momentum": 0.9}),
]
