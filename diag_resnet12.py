"""Diagnostic 12: find optimal optimizer settings for projection-based ResNet."""
import sys, os
...
configs = [
    ("SGD lr=0.5 mom=0.5", "ProjectionSGD", {"lr": 2.0, "momentum": 0.5}),
    ("SGD lr=0.5 mom=0.5", "ProjectionSGD", {"lr": 0.5, "momentum": 0.5}),
    ("SGD lr=0.3 mom=0.9", "ProjectionSGD", {"lr": 0.3, "momentum": 0.9}),
    ("SGD lr=0.3 mom=0.5", "ProjectionSGD", {"lr": 0.3, "momentum": 0.5}),
    ("Adam lr=0.0003", "ProjectionAdam", {"lr": 0.0003}),
    ("Adam lr=0.0001", "ProjectionAdam", {"lr": 0.0001}),
]

for name, opt_name, opt_kwargs in configs:
    print(f"\n=== {name} ===")
